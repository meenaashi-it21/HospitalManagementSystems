...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> SVINM Hospital </a>
...
.myDiv {
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-insu" id="list-insu-list" role="tab" data-toggle="list" aria-controls="home">Insurance Details</a>
               ...
               <div class="col-sm-4" style="left: 5%">
                ...
                <div class="col-sm-4" style="left: 20%;margin-top:5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Insurance Details</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#list-insu" onclick="clickDiv('#list-insu-list')">
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Consultancy Details</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Bill Paid Successfully');" name ="generate_bill" class = "btn btn-success" value="Consultancy Details"/>
                              </a>
                              </td>
                              </form>
...
<div class="tab-pane fade" id="list-insu" role="tabpanel" aria-labelledby="list-insu-list">
         <div class="tab-pane fade  show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
        <div class="container-fluid container-fullw bg-white" >
              <div class="row">
              <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Government Insurance</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#gov-hist" onclick="clickDiv('#list-gov-list')">
                          <a href="gov-insurance.html">View Government Insurance</a>
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Regular Insurance</h2>
                    
                      <p class="cl-effect-1">
                        <a href="#reg-hist" onclick="clickDiv('#list-reg-list')">
                         <a href="reg-insurance.html"> View Regular Insurance</a>
                        </a>
                      </p>
                    </div>
                  </div>
        ...
        <div class="tab-pane fade" id="reg-hist" role="tabpanel" aria-labelledby="list-reg-list">
