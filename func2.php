...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,medical_issues) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword','$medical_issues');";
    ...
    if($result){
        ...
        $_SESSION['medical_issues']=$_POST['medical_issues'];
